...
const housingSchema = new Schema({
    ...
    year: {
        type: Number,
        required: true,
        min: [1850, 'Year have to be at least 1850'],
        max: [2021, 'Year have to be at most 2021']
    },
    city: {
        type: String,
    ...
    propertyDescription: {
        type: String,
        required: true,
        maxLength: [60, 'Description should be at most 60 characters']
    },
    availablePieces: {
        type: Number,
        required: true,
        min: [0, 'Year have to be at least 0'],
        max: [20, 'Year have to be at most 10']
    },
    createdAt: {
        type: String,
        required: true,
